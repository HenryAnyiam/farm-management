# Generated by Django 4.2.13 on 2024-11-30 21:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('This Farm', 'This Farm'), ('Ken Chick', 'Ken Chick'), ('Kuku Chick', 'Kuku Chick'), ('Uzima Chicken', 'Uzima Chicken'), ("Kiplel's Farm", 'Kiplels Farm')], max_length=13)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('house_type', models.CharField(choices=[('Open-Sided Shed', 'Open Sided Shed'), ('Closed Shed', 'Closed Shed'), ('Battery Cage System', 'Battery Cage'), ('Deep Litter House', 'Deep Litter House'), ('Semi-Intensive Housing', 'Semi Intensive Housing'), ('Pasture Housing', 'Pasture Housing')], max_length=22)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('average_mature_weight_in_kgs', models.DecimalField(decimal_places=2, max_digits=3)),
                ('average_egg_production', models.PositiveIntegerField(blank=True, null=True)),
                ('maturity_age_in_weeks', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(8), django.core.validators.MaxValueValidator(24)])),
